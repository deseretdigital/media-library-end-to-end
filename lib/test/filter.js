...
export default async function run() {
    ...
    await start("hive")
        ...
        .expect((res, body, next) => {
            if(!get(body, 'error', false)) {
                logErrors("POST: Expected a 'missing name' error, but no error returned.");
                next(true);
            } else {
                next();
            }
    ...
    */
    await start("hive")
        ...
        .expect((res, body, next) => {
            if(!get(body, 'error', false)) {
                logErrors("POST: Expected a 'missing params' error, but no error returned.");
                next(true);
            } else {
                next();
            }
        ...
        */
        await start("utah")
            ...
            .expect((res, body, next) => {
                if(!get(body, 'error', false)) {
                    logErrors("POST: Expected a 'cannot post with ID' error, but no error returned.");
                    next(true);
                } else {
                    next();
                }
        ...
        */
        ...
        await start("hive")
            ...
            .expect((res, body, next) => {
                ...
                if(JSON.stringify(data) === JSON.stringify(assignIn({id: hiveFilterId }, savedHiveFilter))) {
                    hiveFilterName = data.name;
                    next();
                } else {
                    logErrors("POST (HIVE): Saved filter did not match expected object structure.");
                    console.log('Expected: ', JSON.stringify(assignIn({id: hiveFilterId }, savedHiveFilter)));
        ...
        */
        ...
        await start("utah")
            ...
            .expect((res, body, next) => {
                const data = get(body, 'data', {});
                if(JSON.stringify(data) === JSON.stringify(assignIn({id: utahFilterId }, savedUtahFilter))) {
                    utahFilterName = data.name;
                    next();
                } else {
                    logErrors("POST (Utah.com): Saved filter did not match expected object structure.");
                    console.log('Expected: ', JSON.stringify(assignIn({id: utahFilterId }, savedUtahFilter)));
                    console.log('Received: ', JSON.stringify(data));
                    next(true);
                }
            })
        ...
        */
        const dcFilter = {
            ...
            name: 'E2E DC filter',
            params: 'crop=top:0|left:0|width:500|height:10&resize=width:500&order=resize,crop',
        ...
        await start("dc")
            ...
            .expect((res, body, next) => {
                const data = get(body, 'data', {});
                if(JSON.stringify(data) === JSON.stringify(assignIn({ id: dcFilterId }, dcFilter))) {
                    dcFilterName = data.name;
                    next();
                } else {
                    logErrors("POST (DC): Saved filter did not match expected object structure.");
                    console.log('Expected: ', JSON.stringify(assignIn({ id: dcFilterId }, dcFilter)));
                    console.log('Received: ', JSON.stringify(data));
                    next(true);
                }
            })
        ...
        */
        await start("hive")
            ...
            .expect((res, body, next) => {
                const error = get(body, 'error', null);
                if(!error || !error.includes('You do not have permission to perform the requested action with this resource')) {
        ...
        await start("dc")
            ...
            .expect((res, body, next) => {
                ...
                if(JSON.stringify(data) !== JSON.stringify(response)) {
                    logErrors("PUT (DC | some values sent): Response did not match expected structure.");
            ...
            await start("dc")
                ...
                .expect((res, body, next) => {
                    ...
                    if(JSON.stringify(data) !== JSON.stringify(response2)) {
                        logErrors("PUT (DC | all values sent): Response did not match expected structure.");
        ...
        await start("hive")
            ...
            .expect((res, body, next) => {
                ...
                if(Array.isArray(data)) {
                    logErrors('GET by ID (HIVE): Expected a single object, but got an array.');
                    next(true);
                } else {
                    next();
                }
            ...
            .expect((res, body, next) => {
                const data = get(body, 'data', {});
                if(JSON.stringify(data) !== JSON.stringify(assignIn({ id: hiveFilterId }, getResult))) {
                    logErrors('GET by ID (HIVE): Response body does not match expected structure.');
                    console.log('Expected', JSON.stringify(assignIn({ id: hiveFilterId }, getResult)));
                    console.log('Received', JSON.stringify(data))
                    next(true);
                } else {
                    next();
        ...
        */
        ...
        await start("dc")
            ...
            .expect((res, body, next) => {
                const data = get(body, 'data', false);
                if(Array.isArray(data)) {
                    logErrors('GET by ID (DC): Expected a single object, but got an array.');
                    next(true);
                } else {
                    next();
                }
            ...
            .expect((res, body, next) => {
                const data = get(body, 'data', {});
                if(JSON.stringify(data) !== JSON.stringify(assignIn({ id: dcFilterId }, getResult2))) {
                    logErrors('GET by ID (DC): Response body does not match expected structure.');
                    console.log('Expected: ', JSON.stringify(assignIn({ id: dcFilterId }, getResult2)));
                    console.log('Received: ', JSON.stringify(data));
                    next(true);
                } else {
                    next();
        ...
        */
        ...
        await start("hive")
            ...
            .expect((res, body, next) => {
                ...
                data.forEach((filterItem) => {
                    if(get(filterItem, 'name', '') === hiveFilterName
                        && JSON.stringify(filterItem) === JSON.stringify(assignIn({ id: hiveFilterId }, getResult3))
                    ) {
                        matches = true;
                    }
                });
                if(!matches) {
                    logErrors('GET by name: The filter item found did not match the expected structure.');
                    console.log('Expected: ', JSON.stringify(assignIn({ id: hiveFilterId }, getResult3)));
        ...
        await start("hive")
            ...
            .expect((res, body, next) => {
                ...
                if(get(firstItem, 'id', null) !== offsetIndexFilterId) {
                    logErrors(`GET by offset: Expected first filter in data array to have ID: ${offsetIndexFilterId}, received: ${firstItem.id}`);
                    next(true);
                } else {
                    next();
                }
        ...
        await start("hive")
            ...
            .expect((res, body, next) => {
                if(!Array.isArray(get(body, 'data', null))) {
                    logErrors('GET by application permission: Expected an array of results');
                    next(false);
                } else {
                    next();
                }
            ...
            .expect((res, body, next) => {
                ...
                if(!found) {
                    logErrors('GET by application permission: Expected to find Utah.com filter.');
                    next(false);
                } else {
                    next();
                }
        ...
        */
        await start("hive")
            ...
            .expect((res, body, next) => {
                const error = get(body, 'error', null);
                if(error !== null) {
                    logErrors('GET by ID (getting another clients filter): Unexpected error. Expected error to be null')
                    next(true);
                } else {
                    next();
                }
            ...
            .expect((res, body, next) => {
                ...
                if(JSON.stringify({}) !== JSON.stringify(data)) {
                    logErrors('GET by ID (getting another clients filter): Unexpected data structure found.');
        ...
        await start("hive")
            ...
            .expect((res, body, next) => {
                ...
                data.forEach((item) => {
                    ...
                    if(item.hasOwnProperty('name') || item.hasOwnProperty('params') || item.hasOwnProperty('auto_generate_on_upload') || item.hasOwnProperty('auto_generate_on_demand') || item.hasOwnProperty('ttl_days')) {
                        hasUnexpectedKey = true;
                    }
                });
                if(!hasExpectedKey || hasUnexpectedKey) {
                    logErrors('GET id fields: The fields returned did not match the expected fields.');
                    next(false);
                } else {
                    next();
                }
        ...
        await start("hive")
            ...
            .expect((res, body, next) => {
                ...
                data.forEach((item) => {
                    ...
                    if(item.hasOwnProperty('id') || item.hasOwnProperty('params') || item.hasOwnProperty('auto_generate_on_upload') || item.hasOwnProperty('auto_generate_on_demand') || item.hasOwnProperty('ttl_days')) {
                        hasUnexpectedKey = true;
                    }
                });
                if(!hasExpectedKey || hasUnexpectedKey) {
                    logErrors('GET name fields: The fields returned did not match the expected fields.');
                    next(false);
                } else {
                    next();
                }
        ...
        await start("hive")
            ...
            .expect((res, body, next) => {
                ...
                data.forEach((item) => {
                    ...
                    if(item.hasOwnProperty('id') || item.hasOwnProperty('name') || item.hasOwnProperty('auto_generate_on_upload') || item.hasOwnProperty('auto_generate_on_demand') || item.hasOwnProperty('ttl_days')) {
                        hasUnexpectedKey = true;
                    }
                });
                if(!hasExpectedKey || hasUnexpectedKey) {
                    logErrors('GET params fields: The fields returned did not match the expected fields.');
                    next(false);
                } else {
                    next();
                }
        ...
        */
        await start("hive")
            ...
            .expect((res, body, next) => {
                if(!Array.isArray(get(body, 'data', null))) {
                    logErrors('GET auto_generate_on_upload fields: Expected results to be an array.');
                    next(false);
                } else {
                    next();
                }
            ...
            .expect((res, body, next) => {
                ...
                data.forEach((item) => {
                    ...
                    if(item.hasOwnProperty('id') || item.hasOwnProperty('name') || item.hasOwnProperty('params') || item.hasOwnProperty('auto_generate_on_demand') || item.hasOwnProperty('ttl_days')) {
                        hasUnexpectedKey = true;
                    }
                });
                if(!hasExpectedKey || hasUnexpectedKey) {
                    logErrors('GET auto_generate_on_upload fields: The fields returned did not match the expected fields.');
                    next(false);
                } else {
                    next();
                }
        ...
        */
        await start("hive")
            ...
            .expect((res, body, next) => {
                if(!Array.isArray(get(body, 'data', null))) {
                    logErrors('GET auto_generate_on_demand fields: Expected results to be an array.');
                    next(false);
                } else {
                    next();
                }
            ...
            .expect((res, body, next) => {
                ...
                data.forEach((item) => {
                    ...
                    if(item.hasOwnProperty('id') || item.hasOwnProperty('name') || item.hasOwnProperty('params') || item.hasOwnProperty('auto_generate_on_upload') || item.hasOwnProperty('ttl_days')) {
                        hasUnexpectedKey = true;
                    }
                });
                if(!hasExpectedKey || hasUnexpectedKey) {
                    logErrors('GET auto_generate_on_demand fields: The fields returned did not match the expected fields.');
                    next(false);
                } else {
                    next();
                }
        ...
        await start("hive")
            ...
            .expect((res, body, next) => {
                ...
                data.forEach((item) => {
                    ...
                    if(item.hasOwnProperty('id') || item.hasOwnProperty('name') || item.hasOwnProperty('params') || item.hasOwnProperty('auto_generate_on_upload') || item.hasOwnProperty('auto_generate_on_demand')) {
                        hasUnexpectedKey = true;
                    }
                });
                if(!hasExpectedKey || hasUnexpectedKey) {
                    logErrors('GET ttl_days fields: The fields returned did not match the expected fields.');
                    next(false);
                } else {
                    next();
                }
        ...
        */
        await start("hive")
            ...
            .expect((res, body, next) => {
                ...
                data.forEach((item) => {
                    ...
                    if(item.hasOwnProperty('params') || item.hasOwnProperty('auto_generate_on_upload') || item.hasOwnProperty('auto_generate_on_demand') || item.hasOwnProperty('ttl_days')) {
                        hasUnexpectedKey = true;
                    }
                });
                if(!hasExpectedKeys || hasUnexpectedKey) {
                    logErrors('GET id and name fields: The fields returned did not match the expected fields.');
                    next(false);
                } else {
                    next();
                }
        ...
        await start('hive')
            ...
            .expect((res, body, next) => {
                if(get(body, 'error', false)) {
                    logErrors('DELETE (HIVE): Error deleting filter with id: ', hiveFilterId);
                }
                next();
            })
            .expectStatus(200)
        ...
        await start('utah')
            ...
            .expect((res, body, next) => {
                if(get(body, 'error', false)) {
                    logErrors('DELETE (Utah): Error deleting filter with id: ', utahFilterId);
                }
                next();
            })
            .expectStatus(200)
