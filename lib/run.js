...
export function start(apiKeyName, startBase = base, multiPart = false) {
  return getHippieInstance(startBase, apiKeyName, multiPart);
}

function getHippieInstance(base, apiKeyName, multiPart = false) {
  return hippie()
    .json()
