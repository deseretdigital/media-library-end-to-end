...
export function start(apiKeyName, json = true) {
  return getHippieInstance(base, apiKeyName, json);
}

function getHippieInstance(base, apiKeyName, json = true) {
    // I don't like this, is there a better, read shorthand, way to do it?
  return json ? 
    hippie()
    .json()
